    ...
    <div className="min-h-screen bg-[#FDF6F0]">
      <div className="bg-white border-b border-[#E8D5C4] py-10 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <span className="text-[#D4879E] font-semibold text-sm uppercase tracking-widest">
            Magna Regalos
          </span>
          <h1 className="font-display font-bold text-4xl text-[#8B5E52] mt-2">
            Catálogo de regalos
          </h1>
          <p className="text-[#A08070] mt-2 max-w-md mx-auto">
            Todos nuestros productos para el Día de la Madre y ocasiones
            especiales
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`flex-shrink-0 px-5 py-2 rounded-full text-sm font-medium transition-all ${
                activeCategory === cat
                  ? "bg-[#D4879E] text-white shadow-sm"
                  : "bg-white text-[#8B6F5E] border border-[#E8D5C4] hover:border-[#D4879E]"
              }`}
            >
              {cat}
            </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-[#A08070] text-lg mb-2">
